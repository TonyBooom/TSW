...
public class PagamentoDAO {
	...
	public synchronized  void doSave(PagamentoBean user, User ut) throws SQLException
	{
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		
		String ID = "SELECT id_pagamento FROM tsw.metodo_pagamento ORDER BY id_pagamento DESC LIMIT 1";
